    ...
    <div>
      <div className='px-4 lg:px-14 max-w-screen-2xl mx-auto my-8'>
        <div className='md:w-11/12 mx-auto flex flex-col md:flex-row justify-between items-center gap-12 '>
          <div>
            <img src="https://i.ibb.co/sWPRHX1/about-banner-1.png" alt="about-banner" className='w-[310px] h-[300px]' />
          </div>
          ...
          <div className='md:w-1/2 mx-auto flex sm:flex-row flex-col sm:items-center justify-around gap-12'>
            <div className='space-y-8'>
              <div className='flex items-center gap-4'>
                <MdPeopleAlt className='h-8 w-8 text-brandPrimary' />
                <div>
              ...
              <div className='flex items-center gap-4'>
                <FaHandshake className='h-8 w-8 text-brandPrimary' />
                <div>
            ...
            <div className='space-y-8'>
              <div className='flex items-center gap-4'>
                <GiClick className='h-8 w-8 text-brandPrimary' />
                <div>
              ...
              <div className='flex items-center gap-4'>
                <FaFolder className='h-8 w-8 text-brandPrimary' />
                <div>
